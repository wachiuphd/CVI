...
pdf(file.path(pctdir,"ToxPi-state-pct-subcat-comb-baseline.pdf"),height=8,width=10)
...
cvi.pct.toxpi.comb <- cbind(idcols_gui.df, 
                            data.table(`ToxPi Score`=fcomb.pct.results@txpScores),
                            data.table(fcomb.pct.results@txpSliceScores)) 
fwrite(cvi.pct.toxpi.comb,file.path(pctdir,paste0("CVI-state-pct-comb-baseline.csv")))
# save for use by ToxPi GIS
cvi.pct.toxpi.comb.gis <- cbind(data.table(`ToxPi Score`=fcomb.pct.results@txpScores),
                                idcols_gis.df, 
                                data.table(fcomb.pct.results@txpSliceScores)) 
...
newslicenames <- paste0(slicenames,"!1","!0x",Tol_muted[1:length(slicenames)],"ff")
setnames(cvi.pct.toxpi.comb.gis,slicenames,newslicenames)
fwrite(cvi.pct.toxpi.comb.gis,file.path(pctdir,paste0("CVI-state-pct-comb-baseline.gis.csv")))
...
pdf(file.path(pctdir,"ToxPi-state-pct-subcat-comb-climate.pdf"),height=8,width=10)
...
cvi.pct.toxpi.comb <- cbind(idcols_gui.df, 
                            data.table(`ToxPi Score`=fcomb.pct.results@txpScores),
                            data.table(fcomb.pct.results@txpSliceScores)) 
fwrite(cvi.pct.toxpi.comb,file.path(pctdir,paste0("CVI-state-pct-comb-climate.csv")))
# save for use by ToxPi GIS
cvi.pct.toxpi.comb.gis <- cbind(data.table(`ToxPi Score`=fcomb.pct.results@txpScores),
                                idcols_gis.df, 
                                data.table(fcomb.pct.results@txpSliceScores)) 
...
newslicenames <- paste0(slicenames,"!1","!0x",Tol_muted[1:length(slicenames)],"ff")
setnames(cvi.pct.toxpi.comb.gis,slicenames,newslicenames)
fwrite(cvi.pct.toxpi.comb.gis,file.path(pctdir,paste0("CVI-state-pct-comb-climate.gis.csv")))
